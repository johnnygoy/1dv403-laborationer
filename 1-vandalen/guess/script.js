...
window.onload = function(){
    ...
    var guess = function(number){
        ...
        if (isNaN(number) || number === null){
            alert("Ange ett korrekt tal inom intervallet, endast siffror.");
        }
            ...
            if (number < 0 || number > 100){
                ...
                console.log("Grattis du vann! Det hemliga talet var " + secret + " och du behövde " + number + "gissningar för att hitta det.");
            }
            else if (secret > number){
